...
- [x] **多文件上传 (Multi-File Upload)：** 拖拽式批量上传界面，支持多文件选择、逐文件进度条、拖放区域，无 JS 时自动回退到传统表单
...
- [x] **深色模式 (Dark Mode)：** 一键切换明暗主题，自动记忆用户偏好，全页面适配
- [x] **分页浏览 (Pagination)：** 文档列表、搜索结果、聊天历史等页面统一分页组件，支持页码跳转
