...
# libxml2/libxslt for beautifulsoup4/lxml, libjpeg-turbo for pdfplumber PDF rendering.
...
# Create writable directories for data and config (overridden by volume mounts)
